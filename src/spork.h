...
#define SPORK_15_MN_WINNER_MINIMUM_AGE 10014
...
#define SPORK_15_MN_WINNER_MINIMUM_AGE_DEFAULT 3600               //Age in seconds. Set this to zero to emulate classic behaviour
