...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_15_MN_WINNER_MINIMUM_AGE") return SPORK_15_MN_WINNER_MINIMUM_AGE_DEFAULT;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_15_MN_WINNER_MINIMUM_AGE) return "SPORK_15_MN_WINNER_MINIMUM_AGE_DEFAULT";
